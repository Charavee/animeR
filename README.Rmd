...
2) `anime_rec(x, y)`:  The function takes in genre x and source y and output a list of five anime with their synopsis based on popularity rating.

3) `get_trend()`: This function takes in genre x and year y and output a wordcloud that shows the most recurring themes and words in the anime’s synopsis. 
