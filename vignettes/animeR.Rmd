...
**What is the current trend in the anime industry ?**

For directors who are interested in the current trend in the anime industry, they might be interested in learning about how long most anime are, what are the top producers and the score distribution of their animes, and what genre tends to get a higher score. These users can use the `get_trend(inpute_theme)` function to present the distribution of anime duration, anime score across different producers, and average anime score across all genres. 
...
**What is the score distribution across different anime sources?**

For anime producers who want to understand which anime source has the highest score and the score’s distribution, they can use score_source_byrating( ) to see a side-by-side boxplot of scores across different types of anime. 
